(function() {
    ...
    angular
        ...
        .controller('PlaylistController', function($scope, $rootScope, UserService, PlayQueue, $routeParams, Auth, $sce) {
        ...
        UserService.isFollowingPlaylist($scope.username, $scope.playlist).then(function(booleans) {
