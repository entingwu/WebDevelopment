(function() {
   angular
       ...
       .controller("PlayerController", function($scope, $rootScope, Auth, UserService, PlayQueue, Playback, $location) {
        $scope.view = 'welcome';
        ...
        function updatePlaylists() {
            if ($scope.profileUsername != '') {
                UserService.getPlaylists(Auth.getUsername()).then(function(items) {
