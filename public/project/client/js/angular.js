...
function FormController(element, attrs, $scope, $animate) {
   ...
   *
   * @description
   * Sets the validity of a forms control.
   *
...
var NgModelController = ['$scope', '$exceptionHandler', '$attrs', '$element', '$parse', '$animate',
   ...
   *
   * @description
   * Change the validity state, and notifies the forms when the control changes validity. (i.e. it
   * does not notify forms if given validator is already marked as invalid).
   *
...
!angular.$$csp() && angular.element(document).find('head').prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide{display:none !important;}ng\\:forms{display:block;}.ng-animate-block-transitions{transition:0s all!important;-webkit-transition:0s all!important;}</style>');